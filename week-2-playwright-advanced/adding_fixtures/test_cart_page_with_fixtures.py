...
def test_add_item_to_cart(add_backpack_to_cart):
    ...
    expect(
        add_backpack_to_cart.locator("[data-test='remove-sauce-labs-backpack']")
    ).to_have_text("Remove")
...
def test_removing_item_doesnt_affect_others(add_backpack_and_bike_light_to_cart):
    ...
    # check name of items
    inventory_item_name = add_backpack_and_bike_light_to_cart.locator(
        ".inventory_item_name"
    )
    ...
    add_backpack_and_bike_light_to_cart.locator(
    ...
    expect(
        add_backpack_and_bike_light_to_cart.locator(".inventory_item_name")
