...
def test_add_and_remove_item_from_cart(log_in_to_saucedemo):
    ...
    expect(
        log_in_to_saucedemo.locator("[data-test='remove-sauce-labs-backpack']")
    ).to_have_text("Remove")
    ...
    expect(
        log_in_to_saucedemo.locator("[data-test='add-to-cart-sauce-labs-backpack']")
...
def test_add_two_items_to_cart(log_in_to_saucedemo):
    ...
    expect(
        log_in_to_saucedemo.locator("[data-test='remove-sauce-labs-bike-light']")
    ).to_have_text("Remove")
...
def test_sort_by_price(log_in_to_saucedemo, sort_value, expected_order):
    ...
    log_in_to_saucedemo.locator(".product_sort_container").select_option(sort_value)
    # check ordering
    raw_prices = log_in_to_saucedemo.locator(
